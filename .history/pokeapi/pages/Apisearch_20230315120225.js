...
<main className="min-h-screen bg-fixed bg-cover bg-center" style={{ backgroundImage: "url('pikachu running.gif')" }}>
  <div className="max-w-md mx-32 p-4 bg-white rounded-lg shadow-lg">
    <h1 className="text-4xl font-bold text-center mb-4 text-amber-300">Pokemon</h1>
    <div className="flex items-center mb-4">
      <input
        className="border rounded-l-lg px-2 py-1 w-full md:w-4/5 focus:outline-none focus:ring focus:border-blue-300"
        type="text"
        onChange={(event) => {
      ...
      <button
        onClick={pokeSearch}
        className="bg-amber-500 hover:bg-green-600 rounded-r-lg px-4 py-1 text-white"
      >
        Search
      </button>
    </div>
    <div className="flex flex-col items-center">
      {!choose ? (
        <h1 className="text-center mb-4">Enter your Pokemon!!</h1>
      ) : (
        <div className="flex">
          <div className="mr-20">
