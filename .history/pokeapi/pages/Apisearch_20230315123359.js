  ...
  <div className="w-full md:w-1/2 max-w-md px-4">
    ...
    <div className="bg-amber-100 rounded-lg shadow-lg p-4">
      ...
      (
        <div className='flex'>
          <div className='mr-20'>
            <h1 className='text-2xl font-bold mb-2 text-white '>{PokeEl.name}</h1>
            <img src={PokeEl.img} alt={PokeEl.name} className="mb-4"/>
            <h3 className="text-sm mb-1 font-bold">Species: {PokeEl.species}</h3>
          ...
          <div>
            <h1 className='text-2xl font-bold mb-2 text-white '>{PokeIL.name}</h1>
