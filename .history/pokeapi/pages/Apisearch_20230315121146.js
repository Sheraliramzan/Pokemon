...
<main className="bg-gray-900 min-h-screen flex flex-col justify-center items-center py-4">
...
</main> USE THIS CODE! can style it with pokemon theme, leave the background
    </>
