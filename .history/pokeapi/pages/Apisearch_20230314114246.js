              ...
              (
                <>
                  ...
                  <div>
                    ...
                    <h3 className="text-lg mb-1 font-bold">Supertype: {PokeIL.supertype}</h3>
                    <h3 className="text-lg mb-1 font-bold">Subtypes: {PokeIL.subtypes}</h3>
                    <h3 className="text-lg mb-1 font-bold">Types: {PokeIL.types}</h3>
                    <h4 className="text-base mb-1 font-bold">Hp: {PokeIL.hp}</h4>
                    <h4 className="text-base mb-1 font-bold">Attack: {PokeIL.attacks}</h4>
