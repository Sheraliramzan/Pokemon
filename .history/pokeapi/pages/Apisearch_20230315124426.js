        ...
        <div className="w-full md:w-1/2 max-w-md px-4">
          <div className="bg-amber-100 rounded-lg shadow-lg p-4 mb-4">
            ...
            <div className="flex items-center mb-4">
              ...
              <button onClick={pokeSearch} className="bg-amber-500 hover:bg-yellow-500-600 rounded-r-lg px-4 py-1 text-white">Search</button>
            </div>
         </div>
          ...
          <div className="bg-amber-100 rounded-lg shadow-lg p-4">
            ...
            (
              <div className='flex'>
                <div className='mr-20'>
                  <h1 className='text-2xl font-bold mb-2 text-amber-500 ml-[90%] '>{PokeEl.name}</h1>
