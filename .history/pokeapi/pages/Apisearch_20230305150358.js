...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="rounded-lg min-h-screen flex flex-col justify-center items-center py-4 bg-fixed bg-cover bg-center h-screen" style={{ backgroundImage:"url('pikachu running.gif')" }}>
