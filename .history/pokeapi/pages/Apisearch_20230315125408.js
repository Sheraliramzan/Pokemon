            ...
            (
              <div className='flex'>
                <div className='mr-20'>
                  ...
                  <h3 className="text-md mb-1 font-bold flex flex-row ">Species: {PokeEl.species}</h3>
                  <h3 className="text-md mb-1 font-bold">Type: {PokeEl.type}</h3>
                  <h4 className="text-md mb-1 font-bold">Hp: {PokeEl.hp}</h4>
                  <h4 className="text-md mb-1 font-bold">Attack: {PokeEl.attack}</h4>
                  <h4 className="text-md mb-1 font-bold">Defense: {PokeEl.defense}</h4>
                </div>
              <div>
