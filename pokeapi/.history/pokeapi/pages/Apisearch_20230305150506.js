...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="box-border h-32 w-32 p-4 border-4  min-h-screen flex flex-col justify-center items-center py-4 bg-fixed bg-cover bg-center h-screen" style={{ backgroundImage:"url('pikachu running.gif')" }}>
