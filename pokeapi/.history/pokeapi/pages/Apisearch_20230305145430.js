...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="bg-gray-50 min-h-screen flex flex-col justify-center items-center py-4 bg-fixed bg-cover bg-center h-screen" style="background-image: url('/pikachu\ running.gif')">
